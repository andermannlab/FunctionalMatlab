function affine_transforms = sbxAlignAffineCoreTurboRegAcrossRuns(targetpaths, binned)
...
%   NOTE: hardcoded path to ImageJ.
    ...
    alignstr = sprintf('"-align -window hpdata %s -window hpref %s -affine %s -hideOutput"', ...
